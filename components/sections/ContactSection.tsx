...
const socialLinks = [
  {
    name: 'GitHub',
    href: 'https://github.com/gonzagajaque',
    icon: (
  ...
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/in/gonzagajaque',
    icon: (
      <svg className="w-8 h-8 sm:w-10 sm:h-10" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <Container>
        <div className="max-w-4xl mx-auto">
          <div className="rounded-2xl border border-neutral-200 dark:border-neutral-600 bg-white/30 dark:bg-neutral-800/50 backdrop-blur-lg p-4 sm:p-6 md:p-8 lg:p-10">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 sm:mb-8 text-neutral-900 dark:text-white">
              {t('contact.title')}
            </h2>

            <p className="text-base sm:text-lg text-neutral-700 dark:text-neutral-300 mb-8 sm:mb-12 leading-relaxed">
              {t('contact.description')}
            </p>

            <div className="space-y-6 sm:space-y-8">
            <div>
              <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-neutral-900 dark:text-white">{t('common.labels.email')}</h3>
              <a
                href="mailto:jaquelinesgonzaga@gmail.com"
                className="text-base sm:text-lg text-primary-600 dark:text-primary-400 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 rounded break-all"
              >
                jaquelinesgonzaga@gmail.com
              </a>
            </div>

            <div>
              <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-neutral-900 dark:text-white">{t('common.labels.social')}</h3>
